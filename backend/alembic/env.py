...
# Register identity models with the metadata.
from app.modules.identity.models import (  # noqa: E402, F401
    Hospital,
    Permission,
    RefreshToken,
    Role,
...
# from app.modules.patients.models import Patient  # (future sprints)
