"""Declarative base and mixin classes for all SQLAlchemy models.

Every database model in the application inherits from :class:`Base`.
Mixins provide consistent columns and behavior:
...
- :class:`CommonColumnsMixin` — all of the above combined
"""
...
class Base(DeclarativeBase):
    ...
    Uses the project's naming convention for constraints and indexes.
    """
